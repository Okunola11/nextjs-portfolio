...
const heroGreeting = {
  ...
  subtitle: `A result driven Full Stack Software Developer 🚀 having an experience of building Web applications with JavaScript | Reactjs | Nextjs | Nestjs | Django and some other cool libraries and frameworks.`,
